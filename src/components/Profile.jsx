    ...
    const fetchUserData = async () => {
      try {
        const response = await axios.get(
          "https://chatgrammain.onrender.com/api/auth/myprofile",
          {
...
setMessage(response.data.message);
  ...
  const fetchUserProfilUser = async () => {
    try {
      const response = await axios.get(
        `https://chatgrammain.onrender.com/api/userpost/all`,
        {
          headers: {
...
console.log(use);
  ...
  const Count = async () => {
    try {
      const response = await axios.get(
        `https://chatgrammain.onrender.com/api/user/postCount`,
        {
          headers: {
  ...
  const Bookmark = async () => {
    try {
      const response = await axios.get(
        "https://chatgrammain.onrender.com/api/auth/bookmarked",
        {
  ...
  const del = async () => {
    ...
    try {
      ...
      const response = await axios.delete(
        `https://chatgrammain.onrender.com/api/auth/users/bookmarks`,
        {
          headers: { Authorization: `${token}` },
        }
      );
